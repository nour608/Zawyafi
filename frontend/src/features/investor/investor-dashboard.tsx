...
export const InvestorDashboard = () => {
  ...
  const batchesQuery = useBatches(isConnected)
  ...
  return (
    <main className="space-y-6">
      ...
      <InvestorConnectGate
        title="Connect to access portfolio and wallet sections"
        description="Portfolio positions, wallet actions, and investor analytics are visible after wallet login."
      >
