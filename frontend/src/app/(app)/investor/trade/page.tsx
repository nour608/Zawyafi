...
export default function TradingTerminalPage() {
  return (
    <InvestorConnectGate title="Connect to access trading terminal" description="Trading data and order actions are hidden until wallet login.">
        ...
        <Card className="space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-2 text-sm text-textMuted">Private Markets Token • Series A • Onchain settlement</p>
            </div>
